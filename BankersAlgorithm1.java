import java.util.*;
import java.io.*;
public class BankersAlgorithm1 {
 public static void main(String[] args) throws Exception{
     BufferedReader b = new BufferedReader(new FileReader("F://cse321/lab/lab6/bankalgo.txt"));
     
     int row=Integer.parseInt(b.readLine());
     int column=Integer.parseInt(b.readLine());
     
     String[] process = new String[row+1];
     int[][] max = new int[row+1][column+1];
     int[][] allocation = new int[row+1][column+1];
     int[][] need = new int[row+1][column+1];
     int[][] available = new int[row+1][column+1];
